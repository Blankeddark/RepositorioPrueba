 ...
 */
public class ASTreeAVL <T extends Comparable<T>> implements  IASTree<T>, Iterable 
{

	/**
	 * Atributo que modela la raiz del àrbol
	 */
	private ASTreeNode<T> raiz = null;

	/**
	 * Atributo que modela el peso del àrbol
	 */
	private int peso = 0;
	...
	private void actualizarFactorBalanceoYAltura(ASTreeNode<T> nodoActualizar) 
	{
		...
		alturaDerecha = (hijoMayor == null ? -1 : hijoMayor.darAltura());
